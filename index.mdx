...
Abyss is a **fully on-chain slot machine game** built on Starknet. Every spin, every score, and every item purchase is verified and recorded on the blockchain using Cairo smart contracts and Cartridge VRF for provably fair randomness.
