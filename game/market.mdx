...
The in-game market lets you purchase items using your **session score**. Items provide bonuses that last for the current session only.

<Warning>
Score spent on items is **permanent** - you cannot recover it even if your session ends poorly!
</Warning>
...
3. **Purchase** - Spend score to buy items
4. **Refresh** - Pay score (or use Inferno relic) for new items
